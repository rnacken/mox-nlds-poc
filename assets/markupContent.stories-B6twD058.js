import{j as e}from"./iframe-BfIpySjW.js";import{a as i}from"./mox.config-DLA_t6mp.js";import"./preload-helper-DivXI2Cm.js";const p={title:"MoxCSS/Atoms/Markup Content"},s={a:'<a href="#">This is a link</a>',"a.btn-primary":'<a href="#" class="btn-primary">This is a button</a>',"a.btn-secondary":'<a href="#" class="btn-secondary">This is a button</a>',"a.btn-outline-primary":'<a href="#" class="btn-outline-primary">This is a button</a>',"a.btn-outline-secondary":'<a href="#" class="btn-outline-secondary">This is a button</a>',button:"<button>This is a button</button>",p:"<p>This is a paragraph of text that provides information.</p>",blockquote:"<blockquote>This is a blockquote, used to indicate a section that is quoted from another source.<br /><br />Some more text here.</blockquote>"},t=()=>e.jsxs("div",{children:[e.jsx("style",{children:`
      @layer base {
:is(h1, p, code, hr, a) {
    all: revert;    
}
