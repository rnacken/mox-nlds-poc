import{j as l}from"./iframe-Dy3yv9X5.js";import{c}from"./clsx-B-dksMZM.js";import{p as m}from"./propsToClassNames-WTUPRG8B.js";const d=["color","fontSize","fontWeight","lineHeight","underline","underlineHover"],e=({children:t,as:n,className:o,ref:s,...i})=>{const a=n||"span",{stylePropClassNames:r,restProps:p}=m(d,i);return l.jsx(a,{ref:s,...p,className:c("mox-atom-text-block",r,o),children:t})},h=e;e.__docgenInfo={description:`A text component to be used for any text content.
