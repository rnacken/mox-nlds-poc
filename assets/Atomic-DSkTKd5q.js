import{j as e}from"./iframe-BKLOKDG6.js";import{useMDXComponents as o}from"./index-32Yk516G.js";import{M as l}from"./blocks-Brg9VX_Y.js";import"./preload-helper-DivXI2Cm.js";import"./index-cH6DQo6V.js";const t="/mox-nlds-poc/assets/atomic-design-system-moZ-3hAD.png",d="/mox-nlds-poc/assets/tokens-atoms-etc-aT-pMjYS.png";function i(s){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...o(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Atomic system"}),`
`,e.jsx("div",{className:"sb-container",children:e.jsxs("div",{className:"sb-section-title",children:[e.jsx(n.h1,{id:"atomic-system",children:"Atomic system"}),e.jsx(n.p,{children:"Alles is opgebouwd uit meerdere"}),e.jsxs(n.ul,{children:[`
...
`]}),e.jsx(n.p,{children:"Dit zijn de complexiteits levels van meest simpel naar meest complex."}),e.jsx("img",{src:t,alt:"Opbouw van een atomic design system"}),e.jsx(n.p,{children:"De reden hiervoor is dat dit de beste aanpak is om een design systeem op te zetten voor een brede doelgroep:"}),e.jsxs(n.ul,{children:[`
...
`]}),e.jsx(n.h3,{id:"lv-2---molecules",children:"lv. 2 - Molecules"}),e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Molecules"})," zijn opgebouwd uit ",e.jsx(n.strong,{children:"atoms"})," en zijn daardoor complexer."]}),e.jsxs(n.p,{children:["In principe praten vanaf dit niveau alleen over React componenten (maar enkele elementen met classNames samen kan je op zich beschouwen als ",e.jsx(n.strong,{children:"molecule"}),")."]}),e.jsx(n.h4,{id:"beloftes-1",children:"Beloftes"}),e.jsxs(n.ul,{children:[`
...
`,e.jsxs(n.li,{children:["Nooit omringende spacing zoals ",e.jsx(n.code,{children:"padding"})," of ",e.jsx(n.code,{children:"margin"})]}),`
`]}),e.jsx(n.h3,{id:"lv-4-5---templates-pages",children:"lv. 4, 5 - Templates, Pages"}),e.jsx(n.p,{children:"Sommige pagina's of onderdelen ervan zullen een gebruikelijke opbouw hebben. Denk bijvoorbeeld aan een basis-homepage of een contact-formulier. Heel complex, heel opinionated, maar fijn om te gebruiken als je de 'standaard' gewoon wilt gebruiken."})]})})]})}function m(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{m as default};
